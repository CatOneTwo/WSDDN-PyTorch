    ...
    def forward(self, data, rois, labels):
        ...
        with torch.set_grad_enabled(self.training):
            ...
            if self.training:
                ...
                final_scores = mil_score # TODO need to check
                ...
                tmp = torch.zeros(final_scores.size(0),final_scores.size(1)+1)
                tmp[:,1:] = final_scores  # [roi_num, 20]-> [roi_num, 21] for evaluate


                return_dict['final_scores'] = tmp
